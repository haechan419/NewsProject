...
export function MicrophoneIcon({ size = 24, color = "currentColor" }) {
  return (
    <svg
      width={size}
      height={size}
...
export function NextIcon({ size = 24, color = "currentColor" }) {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      <path
        d="M6 4L14 12L6 20M14 4L22 12L14 20"
        stroke={color}
        strokeWidth="1.5"
        strokeLinecap="round"
        strokeLinejoin="round"
...
export function PrevIcon({ size = 24, color = "currentColor" }) {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      <path
        d="M10 4L2 12L10 20M18 4L10 12L18 20"
        stroke={color}
        strokeWidth="1.5"
        strokeLinecap="round"
        strokeLinejoin="round"
...
export function ErrorIcon({ size = 24, color = "currentColor" }) {
  return (
    <svg
      width={size}
      height={size}
