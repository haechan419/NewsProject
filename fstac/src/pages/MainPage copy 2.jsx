...
const MainPage = () => {
  ...
  // 전체화면 모달 열기
  const openFullscreenModal = (category) => {
    setFullscreenVideoCategory(category);
                ...
                <div className="flex items-center gap-4 sm:gap-6 md:gap-8 animate-marquee whitespace-nowrap absolute">
                  ...
                  <div className="flex items-center gap-4 sm:gap-6 md:gap-8">
                    <div className="flex items-center gap-1">
                      <span className="text-gray-700 text-[10px] sm:text-xs">(USD)</span>
              ...
              {videoCategories.map((category) => {
                ...
                return (
                  <div
                    ...
                    onClick={() => openFullscreenModal(category)}
                  >
                    {/* 비디오 영역 */}
                      ...
                      {hasError && (
                        ...
                        >
                          <div className="text-center text-white px-2">
                            <p className="text-sm font-medium">{getCategoryDisplayName(category)}</p>
                          </div>
                        </div>
                      )}
                    ...
                    {/* 텍스트 영역 */}
                    <div className="p-2">
                      <h3 className="font-semibold text-sm mb-0.5 line-clamp-2 group-hover:text-blue-600 transition-colors leading-tight">
                        {video.title}
                      </h3>
        ...
        >
          ...
          >
            <video
              ...
              controls
              autoPlay
              src={videoData[fullscreenVideoCategory]?.videoUrl}
            >
              <source src={videoData[fullscreenVideoCategory]?.videoUrl} type="video/mp4" />
              Your browser does not support the video tag.
            </video>
          </div>
