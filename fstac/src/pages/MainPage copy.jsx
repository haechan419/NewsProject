...
const MainPage = () => {
  ...
  // 비디오 자동 재생 (타이머 제거 - 비디오가 끝나면 자동으로 다음으로 전환)
  useEffect(() => {
    // interval은 제거하고, 비디오의 onEnded 이벤트로 처리
    return () => {
  ...
  }, [currentVideoIndex, volume, isMuted]);
            ...
            >
              ...
              {videoCategories.map((category, index) => {
                ...
                return (
                  <div
                    key={category}
                    className="video-carousel-item absolute inset-0 transition-opacity duration-500"
                    style={{
