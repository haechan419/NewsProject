...
public class PollinationsImageService {
    ...
    private String getSimpleKeyword(String prompt) {
        ...
        if (p.contains("economy") || p.contains("finance") || p.contains("stock"))
            return "economy";
        if (p.contains("politics") || p.contains("government") || p.contains("president"))
            return "politics";
        if (p.contains("it") || p.contains("tech") || p.contains("ai") || p.contains("computer"))
            return "technology";
        if (p.contains("society") || p.contains("people") || p.contains("city"))
            return "city";
        if (p.contains("culture") || p.contains("art") || p.contains("music"))
            return "art";
        if (p.contains("world") || p.contains("global"))
            return "world map";
